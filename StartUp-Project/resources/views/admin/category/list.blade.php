...
<div class="card-box mb-30">
    <div class="clearfix">
        ...
        <div class="pull-right">
            <a href="{{route('category.create')}}" class="btn btn-primary btn-sm scroll-click" rel="content-y"
    ...
    <table class="data-table table nowrap">
        ...
        <tbody>
            ...
            <tr>
                <td class="table-plus">
                    <img src="{{asset('img/cate.png')}}" width="70" height="70" alt="">
                </td>
                <td>
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                            <a class="dropdown-item" href="{{ route('category.edit', $item->id) }}"><i
